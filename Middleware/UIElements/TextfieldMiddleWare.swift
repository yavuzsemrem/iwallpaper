...
struct TextfieldMiddleWare {
    ...
    func createTextfield(tintColor:UIColor,placeHolder:String,fontSize:CGFloat,placeHolderColor:String,textColor:String,bgColor:String,borderColor:String,borderStyle:UITextField.BorderStyle,borderWidth:CGFloat,cornerRadius:CGFloat,textAlignment: NSTextAlignment = .left) -> UITextField
    {
